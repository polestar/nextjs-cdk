...
// (2) if dynamically imported from deeper @aws-sdk/client-sqs/SQSClient it doesn't
// resolve and is treated as external. However (2) is working in the old way where
// AWS clients are direct dependencies of lambda-at-edge. Might be due to nested
// dynamic imports?
